...
import {
  ...
  Building2, ClipboardList, Microscope, Languages, Stethoscope, Settings, UserPlus,
} from 'lucide-react'
          ...
          <div className="relative" ref={profileRef}>
            ...
            >
              ...
              <div className="hidden md:block">
                ...
                <p className="text-[10px] text-slate-400 leading-tight">{t(`portal.${activePortal}`)}</p>
              </div>
            ...
            {profileOpen && (
              <div className="absolute right-0 top-full mt-2 w-52 bg-white rounded-2xl border border-slate-100 shadow-lg dropdown-shadow z-50 py-1.5 animate-scale-in">
                ...
                <div className="py-1">
                  {activePortal === 'user' && (
                    <button
                      onClick={() => { setProfileOpen(false); router.push('/patient/additional-role') }}
